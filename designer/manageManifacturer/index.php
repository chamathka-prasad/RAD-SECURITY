...
"><i class="me-2 mdi mdi-message-reply text-white"></i></span>
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Manage Manufacturer</h4>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a
                      ...
                      <span class="hidden-xs-down">Registred Manufacturer</span></a>
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      ...
                      <div class="col-12">
                        ...
                        <form class="form-horizontal">
                          <div class="card-body">
                            ...
                            <h4 class="card-title text-center mb-5">Register a New Manufacturer</h4>
                            <div class="row">
                              <div class="col-12 col-lg-6">
                                <div class="form-group row">
                                  <label
                                    for="fname"
                                    class="col-sm-3 text-start control-label col-form-label">Company Name<span class="text-danger">&#8727;</span></label>
                                  <div class="col-sm-9">
                                    <input
                                      type="text"
                                      class="form-control"
                              ...
                              <div class="col-12 col-lg-6">
                                <div class="form-group row">
                                  <label
                                    for="lname"
                                    class="col-sm-3 text-start control-label col-form-label">Mobile</label>
                                  <div class="col-sm-9">
                                    <input
                                      type="text"
                                      class="form-control"
                              ...
                              <div class="col-12 col-lg-6">
                                <div class="form-group row">
                                  <label
                                    for="cono1"
                                    class="col-sm-3 text-start control-label col-form-label">Address</label>
                                  <div class="col-sm-9">
                              ...
                              <div class="col-12">
                                <div class="form-group row ">
                                  ...
                                  <div class="col-sm-9 justify-content-lg-between justify-content-center">
                                    <img src="../../assetss/images/rbmanifacturerimg.png" id="view1" alt="" height="200px">
    ...
    <script>
      ...
      function getAllManufacturer() {
        ...
        fetch("api/getAllManifactures.php", {
            method: "POST",
          })
          .then(function(resp) {
          ...
          .then(function(value) {
            ...
            value.forEach(element => {
              ...
              var imgpath = "../../assetss/images/rbmanifacturerimg.png";
              if (element.img) {
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Manufacturer Details</h1>
                            ...
                            <div class="col-12 col-lg-6">
                              <div class="form-group row">
                                <label
                                  ...
                                  class="col-sm-3 text-start control-label col-form-label">Address</label>
                                <div class="col-sm-9">
                                  <textarea class="form-control" id="uaddress${element.id}">${element.address}</textarea>
                                </div>
                              </div>
                            </div>
                            <div class="col-12">
      ...
      function addNewManufacturer() {
        ...
        if (!cname.value) {
          ...
          fetch("api/addNewManufacturer.php", {
              method: "POST",
              body: formData,
            ...
            .then(function(value) {
              ...
              if (value.type == "error") {
                ...
                setTimeout(() => {
                  window.location = "../manageManifacturer/";
                }, 1000);
              } else {
                toastr.error(
