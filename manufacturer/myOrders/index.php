...
?>
  ...
  <head>
    ...
    <!-- Favicon icon -->
    <title>Manufacturer - My Orders</title>
    <!-- Custom CSS -->
    <link
      rel="stylesheet"
      type="text/css"
...
"
                ...
                <div class="row table-responsive">
                  <table class="table table-striped table-bordered">
                    <thead>
                      ...
                      <th scope="col">Quotation Deadline</th>
    ...
    <script>
      ...
      function getAllOrders(stat) {
        ...
        fetch("api/getAllManufacturerOrders.php", {
            method: "POST",
            body: formData,
          })
          .then(function(resp) {
          ...
          .then(function(value) {
            ...
            value.message.forEach(element => {
              ...
              manuLoader.innerHTML = manuLoader.innerHTML +
                `    <tr role="button" onclick=window.location="orderView?orderNum=${element.uid}">
                          <th>${num}</th>
                          <td>${element.name}</td>
                          <td>${element.datetime}</td>
                           <td>${element.dead_line}</td>
