...
if (isset($_SESSION["rb_manu"])) {
  ...
  $userResult = $db->search("SELECT * FROM `manifacturer` WHERE `id`=?", "i", [$_SESSION["rb_manu"]["id"]]);
              ...
              <ul class="navbar-nav float-end">
                        ...
                        <div class="">
                          ...
                          ?>
                            <a href="../myOrders/orderView/?orderNum=<?=$chat["uid"]?>" class="link border-top">
                              ...
                              "><i class="me-2 mdi mdi-message-reply text-white"></i
                              ></span>
                                <div class="ms-2">
                ...
                <li class="nav-item dropdown">
                  ...
                  "
                    ...
                    if (!empty($_SESSION["rb_manu"]["img"])) {
                      $imagePath = "../../resources/companyImg/" . $_SESSION["rb_manu"]["img"];
                    }
                    ?>
                    <img
                      src="<?= $imagePath ?>"
                          ...
                          <div class="col-12">
                            <div class="form-group row ">
                              ...
                              <div class="col-sm-9 justify-content-lg-between justify-content-center">
                                ...
                                if (!empty($user["img"])) {
                                  $image = "../../resources/companyImg/" . $user["img"];
                                }
                                ?>
