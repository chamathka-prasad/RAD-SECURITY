                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a
                      ...
                      <span class="hidden-xs-down">User List</span></a>
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      ...
                      <div class="col-12">
                        ...
                        <form class="form-horizontal">
                          <div class="card-body">
                            ...
                            <h4 class="card-title text-center mb-5">Register a New User</h4>
                            <div class="row">
                              ...
                              <div class="col-12 col-lg-6">
                                <div class="form-group row">
                                  <label
                                    for="lname"
                                    class="col-sm-3 text-start control-label col-form-label">Type<span class="text-danger">&#8727;</span></label>
                                  <div class="col-sm-9">
                                    <select name="" class="form-select" id="utype">
                                      <option value="select">SELECT</option>
                                      <option value="designer">DESIGNER</option>
                                      <option value="finance">FINANCE</option>
                                      <option value="designer_head">DESIGNER HEAD</option>
    ...
    <div class="modal-content">
      ...
      function addNewManufacturer() {
        ...
        if (!cname.value) {
          ...
          formData.append("type", utype.value);
