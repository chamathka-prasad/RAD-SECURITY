...
<body style="font-family: Arial, sans-serif; background-color: #f9f9f9; color: #333; padding: 20px;">
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <p style="font-size: 16px;">
      You have been successfully registered as a Designer with Robotic Assistance Devices. Please use the following credentials to log in:
    </p>

    <!-- Login Details -->
    <div style="background-color: #f1f1f1; padding: 15px; margin-top: 20px; border-radius: 8px;">
      <p style="font-size: 16px; margin: 0;">UserName: <strong>designer' . $password . '</strong></p>
...
';
        ...
        $message->message = "Designer Register Success";
        echo json_encode($message);
      } else {
        $message->type = "error";
