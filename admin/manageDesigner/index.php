...
?>
  ...
  <head>
    ...
    <title>Designer - Manage Designers</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Manage Designers</h4>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a
                      ...
                      <span class="hidden-xs-down">Designer List</span></a>
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      ...
                      <div class="col-12">
                        ...
                        <form class="form-horizontal">
                          <div class="card-body">
                            ...
                            <h4 class="card-title text-center mb-5">Register a New Designer</h4>
                            <div class="row">
                              <div class="col-12 col-lg-6">
                                <div class="form-group row">
                                  <label
                                    for="fname"
                                    class="col-sm-3 text-start control-label col-form-label">Designer Name<span class="text-danger">&#8727;</span></label>
                                  <div class="col-sm-9">
                                    <input
                                      type="text"
                                      class="form-control"
          ...
          fetch("api/addDesigner.php", {
            ...
            .then(function(value) {
              ...
              if (value.type == "error") {
                ...
                setTimeout(() => {
                  window.location = "../manageDesigner/";
                }, 1000);
              } else {
                toastr.error(
